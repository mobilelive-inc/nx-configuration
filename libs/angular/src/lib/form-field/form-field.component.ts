...
export class FormFieldComponent implements OnInit {
  @ContentChild(FdsFormFieldControl) _controlNonStatic: FdsFormFieldControl<
      any
      >;
  @ContentChild(FdsFormFieldControl, { static: true })
  _controlStatic: FdsFormFieldControl<any>;
