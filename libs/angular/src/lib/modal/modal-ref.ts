...
export const enum FdsModalState {
    OPEN,
    CLOSING,
    CLOSED
}
 ...
 */
export class FdsModalRef<T, R = any> {
    ...
    private _state = FdsModalState.OPEN;
    ...
    private _finishDialogClose() {
        this._state = FdsModalState.CLOSED;
        this._overlayRef.dispose();
    }
