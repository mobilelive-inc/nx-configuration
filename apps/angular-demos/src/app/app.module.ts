...
// importing library
import {AccordionModule, ButtonModule, AngularModule, FdsModalModule} from 'fds-angular';
...
import {CardModule, ProgressModule} from "@friday-design-systems/angular-v2";
