...
@Component({
    ...
    template: `
        <fds-button className="btn--primary btnRounded mb--2">Primary
        </fds-button
        >&nbsp;
        ...
        >&nbsp;
        <fds-button className="btn--success btnRounded mb--2">Success
        </fds-button
        >&nbsp;
        <fds-button className="btn--danger btnRounded mb--2">Danger
        </fds-button
        >&nbsp;
        <fds-button className="btn--warning btnRounded mb--2">Warning
        </fds-button
        >&nbsp;
